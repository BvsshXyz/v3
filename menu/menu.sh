...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/BvsshXyz/permision/main/ip > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/BvsshXyz/permision/main/ip | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/BvsshXyz/permision/main/ip | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/BvsshXyz/permision/main/ip | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/BvsshXyz/v3/main/versions)
export pak=$( cat /home/.ver)
IPVPS=$(curl -s ipinfo.io/ip )
clear
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │                  ${BIWhite}${UWhite}BAYU TUNNELING${NC}"
echo -e "${BICyan} │"
